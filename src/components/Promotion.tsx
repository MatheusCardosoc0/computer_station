...
const Promotion = ({children, image,discount} : PromotionProps) => {
  return (
    <div className='bg-gradient-to-tr from-stone-700 to-slate-800 rounded-br-[40px] rounded-lg rounded-tl-[40px] flex p-2 mt-10 w-[90%] md:w-[34rem] mx-auto flex-col md:flex-row'>
